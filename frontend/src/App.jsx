...
import CommsInboxPage from "./CommsInboxPage.jsx";
...
const Icons = {
  ...
  Mail: (p) => <svg {...p} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>,
...
function Shell({ children, page, setPage, actor, setActor }) {
  ...
  // Comms needs-response count for badge
  const { data: commsData } = useAPI("/api/comms/counts");
  const commsCount = commsData?.needs_response ?? 0;
  ...
  const nav = [
    ...
    { id: "comms", icon: Icons.Mail, label: "Comms", count: commsCount },
